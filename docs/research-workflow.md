...
- 当前研究主阶段定义为 `3.1`。
- 当前已收敛的稳定节点定义为 `3.1.3`。
- 这里的 `3.1 / 3.1.3` 指本仓库中的“毕设/研究工作版本”，不是 ns-3 框架本身的版本号。
...
- 示例：
  ...
  - `chore(v3.1.3): stabilize dual-plane baseline exposure`
