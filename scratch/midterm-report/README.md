...
- The active thesis version is `research-v6.1`.
- The active thesis scenario is now `2x4 + poisson-3ring + overlap-only + beam-only`; older fixed UE layouts and gate combinations are historical context only.
